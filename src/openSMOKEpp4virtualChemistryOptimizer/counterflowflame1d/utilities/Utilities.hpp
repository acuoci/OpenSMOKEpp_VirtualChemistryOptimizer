	...
	std::vector<double>& x, std::vector<double>& T, std::vector<double>& P, std::vector<double>& U, std::vector<double>& G, std::vector<double>& H, std::vector< std::vector<double> >& omega)
{
	...
	ReadFromBackupFile(path_file, x, T, P, U, G, H, omega_backup, names_species_backup);
...
void ReadFromBackupFile(const boost::filesystem::path path_file, std::vector<double>& x, std::vector<double>& T, std::vector<double>& P, std::vector<double>& U, std::vector<double>& G, std::vector<double>& H, std::vector< std::vector<double> >& omega, std::vector<std::string>& names_species)
{
	...
	unsigned int index_U = 7;				// [?]
	unsigned int index_G = 8;				// [?]
	unsigned int index_H = 9;				// [?]
	...
	std::vector< std::vector<double> > additional;
	{
		...
		U = additional[index_U];
		G = additional[index_G];
		H = additional[index_H];
	}
}
