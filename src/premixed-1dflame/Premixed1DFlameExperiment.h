...
#include "OptimizationRules_Premixed1DFlame.h"
...
namespace OpenSMOKE
{
	...
	public:
		...
		const OpenSMOKE::OptimizationRules_Premixed1DFlame* optimization() const { return optimization_; }

	private:

		//OpenSMOKE::OpenSMOKE_PremixedLaminarFlame1D* flame;
		...
		OpenSMOKE::OptimizationRules_Premixed1DFlame*	optimization_;
